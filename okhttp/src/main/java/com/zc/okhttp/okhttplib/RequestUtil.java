...
public class RequestUtil {
    ...
    private boolean isProxy = false;//是否设置代理
    private String ip = "218.60.8.99";
    ...
    RequestUtil(String methodType, String url, Map<String, File> fileMap, String fileType, String json, CallBackUtil callBack) {
        this(methodType, url, json, null, null, null, fileMap, fileType, null, null, callBack);
    }
    ...
    private void getInstance() {
        /*if (isProxy) {
            ...
            mOkHttpClient = new OkHttpClient().newBuilder().proxy(proxy).build();
        } else {
        }*/
